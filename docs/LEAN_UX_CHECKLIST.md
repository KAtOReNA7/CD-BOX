...
Current goal: keep the local single-owner CD-BOX MVP centered on the core collector loop, with evidence-backed online research as the primary AI workflow.
...
- [x] Evidence-backed online research is the primary AI workflow.
- [x] Missing native `web_search` capability selects MusicBrainz/Cover Art Archive instead of presenting ordinary chat as search.
